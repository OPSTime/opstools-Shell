...
/Memory Device$/{do{getline name;if(name~/Size|Speed/){if(name~/No Module Installed/){break};sub(/[ \t]*/,"",name);datearray[i++]=name;}}while(name!~/^Handle/);}
END{print "Count:",i/2;for(n=0;n<i;n++){printf datearray[n]"\t\t";if(n%2 == 1){print ""}}}
'
}
